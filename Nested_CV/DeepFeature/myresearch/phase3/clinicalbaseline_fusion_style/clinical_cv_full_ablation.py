#!/usr/bin/env python
# clinical_featureset_cv_full_ablation.py

"""
Clinical-only CV for comprehensive ablation study.

This version includes ALL meaningful feature combinations for ablation analysis.
"""
...
def main():
    ...
    ap.add_argument("--out_name", type=str, default="clinical_full_ablation")
    ap.add_argument("--seed", type=int, default=42)

    ap.add_argument("--cox_alpha", type=float, default=0.1)  # Match fusion default
    ...
    feature_set_specs = [
        # === Progressive addition with Overall.Stage ===
        {"name": f"age+gender+stage({args.stage_enc})",
         "features": ["age", "gender", "stage"],
         "stage_enc": args.stage_enc},
        
        {"name": f"age+gender+stage+T({args.stage_enc})",
         "features": ["age", "gender", "stage", "T"],
         "stage_enc": args.stage_enc},
        
        {"name": f"age+gender+stage+T+N({args.stage_enc})",
         "features": ["age", "gender", "stage", "T", "N"],
         "stage_enc": args.stage_enc},
        ...
        # === Individual TNM components (without Overall.Stage) ===
        {"name": "age+gender+T",
         "features": ["age", "gender", "T"],
         "stage_enc": args.stage_enc},
        
        {"name": "age+gender+N",
         "features": ["age", "gender", "N"],
         "stage_enc": args.stage_enc},
        
        {"name": "age+gender+M",
         "features": ["age", "gender", "M"],
         "stage_enc": args.stage_enc},
        
        # === Pairs of TNM (without Overall.Stage) ===
        {"name": "age+gender+T+N",
         "features": ["age", "gender", "T", "N"],
         "stage_enc": args.stage_enc},
        
        {"name": "age+gender+T+M",
         "features": ["age", "gender", "T", "M"],
         "stage_enc": args.stage_enc},
        
        {"name": "age+gender+N+M",
         "features": ["age", "gender", "N", "M"],
         "stage_enc": args.stage_enc},
        
        # === Full TNM (without Overall.Stage) ===
        {"name": "age+gender+T+N+M",
         "features": ["age", "gender", "T", "N", "M"],
         "stage_enc": args.stage_enc},
...
#run command:
#python clinical_cv_full_ablation.py.py   
...
#--out_name clinical_full_ablation_onehot  
#--mode sweep  
#--stage_enc onehot  
#--cox_alpha 0.1  
#--norm minmax  
