#!/usr/bin/env python3
"""
Diagnose NSCLC-Radiomics (LUNG1) dataset segmentation availability
...
def main():
    print("="*70)
    print("NSCLC-Radiomics (LUNG1) Segmentation Availability Check")
    print("="*70)
    
    # Get all patient directories (LUNG1-*)
    all_patients = sorted(glob.glob(os.path.join(RAW_BASE, "LUNG1-*")))
    
    print(f"\nFound {len(all_patients)} LUNG1-* patients")
    ...
    output_file = "lung1_segmentation_check.csv"
