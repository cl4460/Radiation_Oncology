...
def process_case(r: dict, out_dir: Path) -> Dict:
    ...
    if bb is None:
        ...
        # Convert margin from mm to voxels (per-axis) # Corrected for zyx spacing, not xyz spacing
...
def main():
    ...
    if truncated_count > len(data) * 0.2:
        print("Warning: >20% of cases truncated. Consider increasing FIXED_PATCH size.")
